...
const getDropCapFontCss = (fontFamily: string, letter: string, isPreviewer: boolean, variant?: DropcapVariant) => {
    const fontStyles: FontStyles = {
        ...
        ImperialScript: {
            A: {
                "font-size": isPreviewer ? "4.2rem" : "4.6rem",
                "margin-right": isPreviewer ? "1.4rem" : "1rem",
            ...
            Y: {
                "font-size": "3.45rem",
                "margin-right": isPreviewer ? "1.4rem" : "1.2rem",
                padding: isPreviewer ? "0.47rem 0.2rem 1rem" : "0.35rem 0.2rem 0rem 0rem",
                ...(isPreviewer && { transform: "scale(1.2)", "line-height": 0.5 }),
            },
            Z: {
                "margin-right": "0.6rem",
                padding: isPreviewer ? "0.47rem 0.2rem 1rem" : "0.35rem 0.2rem 0rem 0rem",
                ...(isPreviewer && { transform: "scale(1.2)" }),
                ...(!isPreviewer && { "font-size": "3.45rem" }),
            },
        },
        EuphoriaScript: {
            A: {
        ...
        Kalam: {
            C: {
                "font-size": isPreviewer ? "4.7rem" : "4.3rem",
            ...
            G: {
                "font-size": isPreviewer ? "4.1rem" : "3.7rem",
                padding: "0.8rem 0rem 0rem",
                "margin-right": "0.25rem",
                "margin-left": "-0.1rem",
                "line-height": 0.8,
            ...
            Q: {
                "font-size": isPreviewer ? "4rem" : "3.6rem",
                padding: "0.65rem 0rem 0rem",
                "margin-right": "0.25rem",
                "margin-left": "-0.1rem",
                "line-height": 0.8,
